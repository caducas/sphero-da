...
var sphero1 = spheron.sphero();
var sphero2 = spheron.sphero();
var spheroPort1 = '/dev/rfcomm0';
// var spheroPort2 = '/dev/rfcomm0';
var COLORS = spheron.toolbelt.COLORS;

sphero1.on('open', function() {
  sphero1.setRGB(COLORS.BLUE, false);
  // sphero1.roll(50,270,1);
  // sphero.stop();
  console.log('opend now');
  sphero1.roll(0,0,0);
});


sphero1.open(spheroPort1);
